...
class Mustache_Engine
{
    ...
    /**
     * Load a Mustache head Template by name.
     *
     * This is a helper method used internally by Template instances for loading head templates. You can most likely
    ...
    public function loadPartial($name)
    {
        try {
            ...
            // If the named head cannot be found, log then return null.
            $this->log(
