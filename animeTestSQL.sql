...
('¿Cuál es el tipo inicial de Pokémon de Ash en la serie de anime?', 0, 1),
('¿Quién es el Profesor Pokémon que da a los entrenadores su primer Pokémon?', 0, 1),
('¿Cuál es el Pokémon legendario que tiene el poder del tiempo?', 0, 1),
('¿Qué tipo de Pokémon es Charizard?', 0, 1),
('¿Cuál es el Pokémon inicial de tipo agua en la región de Kanto?', 0, 1),
('¿Cuál es el Pokémon que evoluciona de Magikarp?', 0, 1),
('¿Quién es el villano principal en el mundo de Pokémon?', 0, 1),
('¿Cuál es el nombre del equipo maligno en la región de Sinnoh?', 0, 1),
('¿Cuál es el legendario que representa la luna en Pokémon Sol y Luna?', 0, 1),
('¿Cuál es el Pokémon inicial de tipo planta en la región de Galar?', 0, 1),
('Nombre de la revista en donde se publica el manga de SNK',0,2),
('¿Cuál es el nombre de la primera esposa de Grisha Jaeger?',0,2),
('¿Quiénes son los personajes principales?', 0, 2),
('¿Cuál es la trama principal de la serie?', 0, 2),
('¿Dónde se desarrolla la historia de Attack on Titan?', 0, 2),
('¿Qué son los Titanes en el mundo de Attack on Titan?', 0, 2),
('¿Cuál es el objetivo de la Legión de Reconocimiento?', 0, 2),
('¿Qué es el muro más externo en la serie?', 0, 2),
('¿Quién es Eren Yeager y cuál es su papel en la historia?', 0, 2),
('¿Qué son los titanes cambiantes?', 0, 2),
('¿Quiénes son los antagonistas principales en Attack on Titan?', 0, 2),
('¿Cuál es el significado de la frase "¡Soy tu enemigo!"?', 0, 2),
('¿Quién es el protagonista principal de "Banana Fish"?', 0, 3),
('¿Qué es "Banana Fish" en la serie?', 0, 3),
('¿Dónde tiene lugar principalmente la historia de "Banana Fish"?', 0, 3),
('¿Quién es el líder de la pandilla de Ash en "Banana Fish"?', 0, 3),
('¿Qué tipo de arma es "Banana Fish" en la serie?', 0, 3),
('¿Quién es el hermano mayor de Ash en "Banana Fish"?', 0, 3),
('¿Quién es el fotógrafo que ayuda a Ash y Eiji en "Banana Fish"?', 0, 3),
('¿Cuál es el objetivo principal de Ash en "Banana Fish"?', 0, 3),
('¿Qué significado tiene "Banana Fish" como nombre?', 0, 3),
('¿Quién es el villano principal en "Banana Fish"?', 0, 3),
('¿Quienes son los autores de Death Note?',0,4),
('¿Cual es la primera víctima en la cual Light prueba la Death Note?',0,4),
('¿Cuál es el nombre completo del protagonista de "Death Note"?', 0, 4),
('¿Cuál es el nombre del shinigami que deja caer el Death Note al mundo humano?', 0, 4),
('¿Qué es necesario para que el Death Note tenga efecto en una persona?', 0, 4),
('¿Quién se hace conocido como "L" en la serie "Death Note"?', 0, 4),
('¿Cómo mueren las personas cuyos nombres se escriben en el Death Note?', 0, 4),
('¿Quién es el rival principal de Light en su intento por atraparlo?', 0, 4),
('¿Qué es lo que lleva consigo un shinigami?', 0, 4),
('¿Cómo se llama el cuaderno que Misa Amane usa en "Death Note"?', 0, 4),
('¿Qué es lo que debe hacer un usuario de Death Note para evitar ir al infierno después de morir?', 0, 4),
('¿Qué se requiere para que alguien sea un legítimo usuario del Death Note?', 0, 4),
('¿Contra que equipo debuto Yamaguchi con su saque?',0,5),
('¿Quién es el protagonista principal de "Haikyuu!"?', 0, 5),
('¿Cuál es la posición de juego de Hinata en el equipo de voleibol?', 0, 5),
('¿Cuál es la escuela secundaria de Kageyama?', 0, 5),
('¿Quién es el capitán del equipo Karasuno?', 0, 5),
('¿Cuál es el apodo de Karasuno High School?', 0, 5),
('¿Qué escuela es conocida por su equipo con uniformes negros?', 0, 5),
('¿Quién es el entrenador del equipo Karasuno?', 0, 5),
('¿Cuál es el segundo nombre de Shoyo Hinata?', 0, 5),
('¿En qué año Hinata comienza la preparatoria?', 0, 5),
('¿Cuál es el título de la canción de apertura de la primera temporada de "Haikyuu!"?', 0, 5);
